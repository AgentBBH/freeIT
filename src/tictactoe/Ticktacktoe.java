 ...
 * Для этого задания создайте отдельную от домашних заданий ветку с именем, например, “tictactoe”
 * 1. Не используя классы и методы - все в методе main
 * 2. Не используя утильные классы (Arrays и Math)
 * 3. Игра должна продолжаться до тех пор, пока не будет выявлен победитель (три "О" или три "Х" в ряд или по диагонали)
